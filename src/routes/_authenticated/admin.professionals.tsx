...
export const Route = createFileRoute("/_authenticated/admin/professionals")({
  head: () => ({
    meta: authPageMeta({
      title: "Moderate Professionals",
      description: "Review, approve, and manage professional profiles.",
    }),
  }),
    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="No professional profiles match your filter."
        />
      ) : (
              ...
              <CardContent className="flex flex-wrap items-center justify-between gap-4 p-4">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    /{p.slug} · {p.town ?? "—"} · ⭐ {p.avg_rating ?? "—"} ({p.review_count ?? 0}) ·
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => act(p.id, p.is_verified ? "unverify" : "verify")}
                  >
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => act(p.id, p.is_featured ? "unfeature" : "feature")}
                  >
