  ...
  head: () => ({
    meta: [
      { title: "Rental Houses & Commercial Properties in Kenya | HostPulse" },
      {
        name: "description",
        content:
          "Browse bedsitters, apartments, maisonettes, townhouses, office spaces and more across Kenya. Filter by county, town, and budget.",
      },
      { property: "og:title", content: "Rental Houses in Kenya" },
      {
        property: "og:description",
        content: "Find rentals and commercial spaces across Kenya's 47 counties.",
      },
      ...
      <section className="border-b bg-gradient-to-b from-primary/5 to-transparent">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="mt-3 max-w-2xl text-lg text-muted-foreground">
            {parent?.description ??
              "Residential and commercial rentals across Kenya. Choose a property type to see listings by county, town, and budget."}
          </p>
          <div className="mt-6">
            <PlanWithAI
              seed={{
                module: "rental",
                seed_intent: "Help me find a rental in Kenya within my budget",
              }}
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
              ...
              <Card className="h-full transition-all hover:border-primary hover:shadow-md">
                ...
                <CardContent>
                  <p className="text-xs text-muted-foreground">
                    Browse {c.name.toLowerCase()} listings across Kenya.
                  </p>
                </CardContent>
              </Card>
            </Link>
        ...
        {isError && children.length === 0 && (
          <div className="mt-6">
            <ErrorState
              description={
                error instanceof Error ? error.message : "Unable to load property categories."
              }
            />
          </div>
        )}
        {!isLoading && !isError && children.length === 0 && (
          <div className="mt-6">
            <EmptyState
              ...
              description="Categories are being seeded — check back soon."
            />
          </div>
        )}
      </section>
